...
namespace AtmOneMonitoringLibrary.Migrations
{
    ...
    partial class AtmOneMonitorContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("AtmOneMonitoringLibrary.Models.AppUser", b =>
                {
                    ...
                    b.OwnsOne("AtmOneMonitoringLibrary.Models.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
