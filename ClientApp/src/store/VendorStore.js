...
exports.actionCreators = {
    getVendors: function () { return function (dispatch) {
        (function fetch() {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, axios_1.default.get("api/vendor")];
                        case 1:
                            response = _a.sent();
                            if (response)
...
exports.reducer = function (state, incomingAction) {
    ...
    switch (action.type) {
        case "GET_VENDORS":
            return __assign(__assign({}, state), { loading: false, vendors: action.payload });
