  ...
  public class UsersController : ControllerBase
  {
    ...
    private List<LdapUser> GetUsersList()
    {
      ...
      users = new List<LdapUser> {
         new LdapUser{ UserName="ho250019", Email="ho250019@ncr.com", FullName="Ojulari Hakeem O" },
         new LdapUser{ UserName="aojo2344", Email="aojo@ecobank", FullName="Ayo Ojo" },
         new LdapUser{ UserName="sb120013", Email="sb120013@ncr.com", FullName="Shina Bankole" },
         new LdapUser{ UserName="ob122073", Email="ob122073@ncr.com", FullName="Olanrewaju Busayo" },
         new LdapUser{ UserName="js908332", Email="js908332@ncr.com", FullName="Jason Sharon" },
         new LdapUser{ UserName="us230019", Email="us230019@ncr.com", FullName="Usman Salman" },
         new LdapUser{ UserName="oa532409", Email="oa532409@ncr.com", FullName="Omooba Ayobola" },
         new LdapUser{ UserName="ha201020", Email="ha201020@ncr.com", FullName="Halima Akinboye" }
      };

      for (int i = 0; i < 50000; i++)
      {
        users.Add(new LdapUser { UserName = $"ho23001{i}", Email = $"ho23001{i}@ncr.com", FullName = "Ojulari Hakeem O" });
      }

      return users;
    }

    //private IActionResult GenerateFile(List<UsersDTO> users)
    //{
    ...
    //  worksheet.Cell(currentRow, 4).Value = "Rolename";
    ...
    //  worksheet.Cell(currentRow, 8).Value = "Approved Status";
    ...
    //    worksheet.Cell(currentRow, 3).Value = user.FullName;
    //    worksheet.Cell(currentRow, 4).Value = user.RoleName;
    //    worksheet.Cell(currentRow, 5).Value = user.Email;
    //    worksheet.Cell(currentRow, 6).Value = user.CreatedBy;
    //    worksheet.Cell(currentRow, 7).Value = user.Status;
    //    worksheet.Cell(currentRow, 8).Value = user.Approved;
    //  }

    //  using var stream = new MemoryStream();
    //  workbook.SaveAs(stream);
    //  var content = stream.ToArray();
    //  return File(content, "appplication/vnd.openxmlformats.officedocument.spreadsheetml.sheet", "Users.xlsx");
    //}
